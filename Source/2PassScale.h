...
private:
    ...
    void HorizScale (   _DataType           *pSrc, 
                        UINT                uSrcWidth,
                        UINT                uSrcHeight,
                        _DataType           *pDst,
                        UINT                uResWidth,
...
ScaleRow (  _DataType           *pSrc, 
            ...
            LineContribType    *Contrib)
{
    _DataType *pSrcRow = &(pSrc[uRow * uSrcWidth]);
...
{ 
    ...
    {   // No scaling required, just copy
        memcpy (pDst, pSrc, sizeof (_DataType) * uSrcHeight * uSrcWidth);
    }
