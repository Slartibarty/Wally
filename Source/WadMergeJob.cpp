...
BOOL CWadMergeJob::MergeWAD( CWADList *pWADList, DWORD dwFlags, CWadMergeDlg::LPTHREAD_PARAM lpParam )
{
	...
	::PostMessage( lpParam->pMergeStatus->m_hWnd, WM_WAD_MERGE_STATUS_CUSTOM, WAD_MERGE_STATUS_IMAGE_COUNT, (LPARAM)lpStatus );
	...
	while( pItem )
	{
		...
		::PostMessage( lpParam->pMergeStatus->m_hWnd, WM_WAD_MERGE_STATUS_CUSTOM, WAD_MERGE_STATUS_STEP, (LPARAM)lpStatus );		
